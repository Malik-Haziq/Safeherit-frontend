...
export const EditValidatorModal = (_props: {
  openModal: boolean
  closeModal: any
  closeModalOnOverlayClick: boolean
  modalControl: {
...
function TextArea(_props: {
  ...
  return (
    <textarea
      ...
      value={_props.modalControl[_props.name]}
      onChange={_handleChange}
      className="w-[446px] h-[510px] bg-[#F5FAFD] rounded-3xl text-[#6F767B] py-7 px-5 overflow-auto border-[1px] border-[#065A934D] focus:bg-[#e8f2f8] focus:border-[#065b9371] focus:outline-none resize-none"
    ></textarea>
  )
}
