    ...
    return <main className='m-w-[1280px] mx-auto font-safe-font-default'>
        ...
        <section className='max-w-[941px] mx-auto mb-24 px-5'>
            ...
            <section className='flex justify-around items-center flex-wrap'>
                <article className='flex flex-col justify-center items-center max-w-[270px]'>
                    ...
                    <p className='text-xl font-light text-center'>Unaccounted assets in the United States</p>
                </article>
                <article className='flex flex-col justify-center items-center max-w-[270px]'>
                    <h3 className='text-[#04477B] text-[27px] font-semibold '>As much as 50%</h3>
                    <p className='text-xl font-light text-center'>of Estate Assets are lost due to poor planning</p>
                </article>
                <article className='flex flex-col justify-center items-center max-w-[270px]'>
                    <h3 className='text-[#04477B] text-[27px] font-semibold '>$250,000</h3>
                    <p className='text-xl font-light text-center'>Average Estate loss due to poor planning</p>
                </article>
            </section>
        </section>
        ...
        <section className='bg-[#065A93] py-10 mb-24 px-5'>
            <div className=' max-w-[1280px] mx-auto text-white flex flex-col gap-5 text-[22px]'>
                ...
                <p>SafeHerit offers a powerful solution to these challenges. Our platform provides a secure, efficient, and private way to manage your digital assets and ensure they reach your intended beneficiaries.</p>
                <p>With SafeHerit, you can easily catalogue all your digital assets, from bank accounts to social media profiles, and designate who should receive them. Our system uses robust encryption for maximum security and absolute privacy. We ensure that your digital legacy is protected and will be passed on according to your wishes.</p>
                <p>No more worrying about lost assets or complicated schemes. With SafeHerit, managing your digital legacy becomes simple, secure, and stress-free.</p>
            </div>
        </section>
            ...
            <section className='flex justify-between gap-10 mb-10'>
                ...
                <aside className='basis-1/2'>
                    <div className='mb-10'>
                        ...
                        <p className='text-[22px]'>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt.</p>
                        <a href="#">Learn more →</a>
                    </div>
                    <div>
                        ...
                        <div className='flex items-center gap-2'> 
                            <span className='text-[#04477B40] text-[100px] font-semibold font-serif'>“</span>
                            <p>Lorem ipsum dolor sit amet, onsectetur adipisicing elit, sed do eiusmod tempor incididunt.</p>
                        </div>
                    </div>
                </aside>
            </section>
        ...
        <section className='mx-auto px-5 flex gap-3 items-center flex-col justify-center mb-24'>
            ...
            <div className='flex gap-3'>
                <input type="text" placeholder='Enter email' className='px-8 py-5 text-[#082A44] font-medium bg-[#F5FAFD] focus:outline-none rounded-3xl'/> 
                <button  className='px-6 py-5 text-white font-semibold bg-[#0C8AC1] rounded-3xl'>Start free trial</button>
            </div>
        </section>
    </main>
}
